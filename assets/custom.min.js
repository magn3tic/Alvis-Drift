...
$(function() {
    ...
    var containerScene1 = new ScrollMagic.Scene({
        ...
        offset: -150
    }).setClassToggle('.parallax-h .home-aboutus h2', 'textAnimate').reverse(!1).addTo(controller);
    var containerScene2 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .home-aboutus',
        offset: -150
    }).setClassToggle('.parallax-h .home-aboutus p', 'textAnimate').reverse(!1).addTo(controller);
    var containerScene5 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .home-product-items',
        offset: -100
    }).setClassToggle('.parallax-h .home-product-items', 'home-product-animate').reverse(!1).addTo(controller);
    var containerScene6 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-story',
        offset: -100
    }).setClassToggle('.parallax-h .our-story', 'our-story-animate').reverse(!1).addTo(controller);
    var containerScene7 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-vineyards',
        offset: 0
    }).setClassToggle('.parallax-h .our-vineyards', 'our-vineyards-animate-before').addTo(controller);
    var containerScene8 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-vineyards',
        offset: 820
    }).setClassToggle('.parallax-h .our-vineyards', 'our-vineyards-animate-after').addTo(controller);
    var containerScene9 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-cellars',
        offset: -50
    }).setClassToggle('.parallax-h .our-cellars', 'our-cellars-animate-before').addTo(controller);
    var containerScene10 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-cellars',
        offset: 820
    }).setClassToggle('.parallax-h .our-cellars', 'our-cellars-animate-after').addTo(controller);
    var containerScene11 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-rewards',
        offset: 0
    }).setClassToggle('.parallax-h .our-rewards', 'our-rewards-animate-before').addTo(controller);
    var containerScene12 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-rewards',
        offset: 820
    }).setClassToggle('.parallax-h .our-rewards', 'our-rewards-animate-after').addTo(controller);
    var containerScene13 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-social-impact',
        offset: 0
    }).setClassToggle('.parallax-h .our-social-impact', 'our-social-impact-animate-before').addTo(controller);
    var containerScene14 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-social-impact',
        offset: 820
    }).setClassToggle('.parallax-h .our-social-impact', 'our-social-impact-animate-after').addTo(controller);
    var containerScene20 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .newsletter-sec',
        offset: -100
    }).setClassToggle('.parallax-h .newsletter-sec', 'newsletter-sec-animate').reverse(!1).addTo(controller);
    var containerScene7 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-vineyards.our_family_parallex',
        offset: 0
    }).setClassToggle('.parallax-h .our-vineyards.our_family_parallex', 'our-family-animate-before').addTo(controller);
    var containerScene8 = new ScrollMagic.Scene({
        triggerElement: '.parallax-h .our-vineyards.our_family_parallex',
        offset: 820
    }).setClassToggle('.parallax-h .our-vineyards.our_family_parallex', 'our-family-animate-after').addTo(controller)
});
